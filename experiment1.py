...
from numpy import pi, sqrt, array, std
...
def check_constant(I_values, R_values):
    out = []
    I_values = array(I_values)
    R_values = array(R_values)

    out = (I_values**2)*(R_values**2)
    print out
    return out
...
print std(check_constant(I_values[0], R_values))
